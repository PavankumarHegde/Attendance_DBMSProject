...
<body id="page-top" style="background-color:yellow;">
  <div id="wrapper">
    <!-- Sidebar -->
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Query Executor</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Run Your MySQL Query HERE --></h6></div><br>
				  <form action="" method="POST" class="form-control">
						...
						$query=$_POST['query'];}
						?>
						<input type="query" class="form-control" value='<?php echo "$query"; ?>' name="query" id="exampleInputEmail" placeholder="Enter Your Query To Execute">
						</div>
              ...
              <div class="card mb-4">
				...
				if($conn)
				{
					...
					if($result){
						...
						if($qry_array[0]=='UPDATE')
						{
							exit("Updated Successfully");
							
						}
						if($qry_array[0]=='DELETE')
						{
							exit("Deleted Successfully");
							
						}
						if($qry_array[0]=='CREATE')
						{
							exit("Created Successfully");
							
						}
						if($qry_array[0]=='INSERT')
						{
					...
					if(mysqli_num_rows($result)<=0)
					{
						...
						//header("location:/demo/login/login.php?failed");
					}else{
						$i = 0;
                    ...
                    <thead class="thead-dark">
                      <tr>
						...
						while ($i < mysqli_num_fields($result))
						{
							...
							echo '<th bgcolor="lightgreen">' . $meta->name . '</th>';
							$i = $i + 1;
						}
						echo '</tr>';
